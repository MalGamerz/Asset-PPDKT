 ...
 */
    ...
    namespace Illuminate\Support\Facades {use Illuminate\Auth\AuthManager;use Illuminate\Contracts\Auth\UserProvider;use InvalidArgumentException;
            /**
     *
     *
     ...
     */
         ...
         * @static
         */
        public static function createUserProvider(string $provider = null):?UserProvider
        {
                        /** @var AuthManager $instance */
